...
@Component({
  ...
  template: `
<ng-container>
  <a [routerLink]="'/contacto'" class="contenedor-pregunta">
    <img src="../../assets/img/whatsappIcon.png" class="w-100" alt="Pregunta">
  </a>

  <a [routerLink]="'/contacto'" *ngIf="showCartel" class="mensaje fadeIn d-flex">
    <svg width="50" height="50" fill="#b91828" class="bi bi-chat-dots-fill mr-3" viewBox="0 0 16 16">
