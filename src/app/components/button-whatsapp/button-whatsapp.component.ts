...
@Component({
  ...
  template: `
  <ng-container>
  <a href="https://wa.me/+5491127225447?text=Hola%20quiero%20información%20de%20la%20rutina" target="_blank" class="contenedor-pregunta" #boton>
  <img src="../../assets/img/whatsappIcon.png" class="w-100" alt="Pregunta">
</a>

<a href="https://wa.me/+5491127225447?text=Hola%20quiero%20información%20de%20la%20rutina" target="_blank"  *ngIf="showCartel" class="mensaje fadeIn d-flex">
